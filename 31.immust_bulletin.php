<html>
    ...
    <style>
        *{
        ...
        /* banner*/
        .banner{
            background-image: linear-gradient(#ffffff,#b286cd);
            padding:30px;
        }
        .banner h1{
            padding: 20px;
        ...
        .faculty .teacher h3{
            color: White;
            background-color: rgba(221,181,16,.500);
            text-align: center;           
        }
        /*contact*/
        .contact {
        ...
        .bulletin{
            display: block;
            justify-content: center;
            background-color: rgb(247,141,179);
            padding: 30px 0;
    ...
    <body>
        ...
        <div class="slider">
            <div class="flexslider">
                <ul class="slides">
                    <li><img src="https://mustwebsystem.must.edu.tw/ashx/chchou/showMustWwwImage.ashx?filegid=181616" /></li>
                    <li><img src="https://mustwebsystem.must.edu.tw/ashx/chchou/showMustWwwImage.ashx?filegid=171571" /></li>
                    <li><img src="https://mustwebsystem.must.edu.tw/ashx/chchou/showMustWwwImage.ashx?filegid=161362" /></li>
                </ul>
            </div>
        </div>
        <!---佈告欄--->
